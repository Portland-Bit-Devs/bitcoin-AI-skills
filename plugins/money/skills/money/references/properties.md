...
Without it there is no single price for "one unit," because units differ. Note that
fungibility can be degraded by surveillance and blacklisting even when it holds physically
or protocol-wise — a unit known to have a particular history may be accepted at a discount.
